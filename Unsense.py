...
'10.235186\t11.321997\n'
    ...
    dataMat=mat(datArr);
    return dataMat;
dataMat = loadDataSet('D:/require/ldq0402/lideqiang_20180402102412_y.csv');


X_pca= decomposition.TruncatedSVD(n_components=2).fit_transform(dataMat)
df=pd.DataFrame(data=X_pca,columns=list('AB'))
